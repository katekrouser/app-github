...
export class SmartTablePage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.smartTableContainer = this.page.locator('nb-card', {
      hasText: 'Smart Table',
    });

    this.addButton = this.smartTableContainer.locator('.ng2-smart-action-add-add');

    // Filters
    this.idFilterInput = this.smartTableContainer.locator('thead').getByPlaceholder('ID');

    this.firstNameFilterInput = this.smartTableContainer
      .locator('thead')
      .getByPlaceholder('First Name');

    this.lastNameFilterInput = this.smartTableContainer
      .locator('thead')
      .getByPlaceholder('Last Name');

    this.usernameFilterInput = this.smartTableContainer
      .locator('thead')
      .getByPlaceholder('Username');

    this.emailFilterInput = this.smartTableContainer.locator('thead').getByPlaceholder('E-mail');

    this.ageFilterInput = this.smartTableContainer.locator('thead').getByPlaceholder('Age');

    // Create form row
    this.createRow = this.smartTableContainer.locator('tr[ng2-st-thead-form-row]');
    ...
    this.createButton = this.createRow.locator('.ng2-smart-action-add-create');

    this.cancelCreateButton = this.createRow.locator('.ng2-smart-action-add-cancel');

    this.tableRows = this.smartTableContainer.locator('tbody tr.ng2-smart-row');
  }
